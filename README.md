...
<section>
  <img align="right" src='/assets/foto_perfil.jpeg' width="25%" alt="Foto de perfil" />
  <p align="left" width="65%">
    <pre>Front-end Software Developer<br />Tecnólogo em Análise e Desenvolvimento de Sistemas</pre>
  </p>
</section>
...
<br>
<p align="center">
  <img src="/assets/2022-1/gif_localizacao_pagweb.gif" width="100%" alt="GIF de exemplificação" />
</p>

[Youtube (Qualidade melhor)](https://www.youtube.com/watch?v=vAR8DCsnbfE)
...
<br>
<p align="center">
  <img src="/assets/2022-2/Cadastro_canais_adm.gif" width="100%" alt="GIF de exemplificação" />
</p>

[Youtube (Qualidade melhor)](https://www.youtube.com/watch?v=UtJIXQ2DS-o)
...
No desenvolvimento do front-end, eu trabalhei em estreita colaboração com outros membros da equipe para desenvolver o design das interfaces e aprender a utilizar eficientemente a ferramenta. Isso me permitiu aprofundar meu conhecimento na biblioteca React e na criação de componentes reutilizáveis. Já no backend, eu colaborei com os outros membros da equipe para definir a estrutura da API e implementar as funcionalidades solicitadas pelos requisitos funcionais e não funcionais do projeto. Também fui o responsável pela aplicação dos principios do SOLID, onde eu mesmo defini a estrutura e organização dos arquivos a serem usados.

Portanto, como contribuições pessoais, eu fui responsável pela criação dos designs no Figma, pela contribuição na implementação do backend e toda sua API, principalmente na aplicação dos principios do SOLID, onde eu mesmo defini a estrutura e organização dos arquivos a ser usada. Isso me permitiu aprofundar meu conhecimento em desenvolvimento de interfaces de usuário e a organização de código.
